...
def start_game(ai_settings, screen, stats, ship,
                      aliens, bullets):
    """Start's game by pressing 'p' key."""
...
def update_screen(ai_settings, screen, stats, sb, ship, alien, bullets, play_button):
    ...
    #Draw the pay button if the game is inactive
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    #Adding 50 points every time alien hit
    if collisions:
...
def get_number_rows(ai_settings, ship_height, alien_height):
    """Determine the number of aliens that will fit on a screen"""
